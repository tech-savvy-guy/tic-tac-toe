    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-8 select-none">
      <div className="w-full max-w-xs space-y-12 animate-in fade-in duration-500">
        <div className="text-center space-y-4">
          <h1 className="text-5xl font-extralight tracking-wider text-foreground">TIC</h1>
          <div className="w-16 h-px bg-foreground mx-auto"></div>
          <h1 className="text-5xl font-extralight tracking-wider text-foreground">TAC</h1>
          <div className="w-16 h-px bg-foreground mx-auto"></div>
          <h1 className="text-5xl font-extralight tracking-wider text-foreground">TOE</h1>
        </div>

        <div className="space-y-4">
          <button
            onClick={() => onModeSelect("single")}
            className="w-full py-4 text-foreground font-light tracking-wide hover:bg-foreground hover:text-background transition-all duration-300 border border-muted-foreground hover:border-foreground group"
          >
